...
class yoga_service_widget extends WP_Widget {    
	...
	?>
				...
				<td style="margin-bottom: 30px;">
                    <label for="<?php echo $this->get_field_id('service_title'); ?>"><?php esc_attr_e('Service Title', 'yoga'); ?></label>
                </td>
				<td>
				...
				<td>
                    <label for="<?php echo $this->get_field_id('service_desc'); ?>"><?php esc_attr_e('Service Description', 'yoga'); ?></label>
                </td>
				<td>
        ...
        <tr>
        		<td>
        			<label for="<?php echo $this->get_field_id('btnmore'); ?>"><?php esc_attr_e('Button Label', 'yoga'); ?></label>
        		</td>
        		<td>
        	...
        	<tr>
        		<td colspan="2">
        			<input type="checkbox" name="<?php echo $this->get_field_name('open_new_window'); ?>" id="<?php echo $this->get_field_id('open_new_window'); ?>" <?php if( !empty($instance['open_new_window']) ): checked( (bool) $instance['open_new_window'], true ); endif; ?> ><?php esc_attr_e( 'Open Button Link in new window?','yoga' ); ?>
        		</td>
        	</tr>
		</table>	
    <?php
